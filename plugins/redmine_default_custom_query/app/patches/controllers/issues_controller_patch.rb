...
module DefaultCustomQuery
  module IssuesControllerPatch
    ...
    included do
      ...
      alias_method:retrieve_query_from_session, :default_url_options
    end
    ...
    def retrieve_query_from_session_with_default_url_options
      if default_query_module_enabled?
        if session[:query]
          retrieve_query_from_session_without_default_url_options
        else
    ...
    def default_query_module_enabled?
      @project && @project.module_enabled?(:default_url_options)
    end
